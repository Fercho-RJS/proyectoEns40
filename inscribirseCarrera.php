        ...
        <div class="modal-content">
          ...
          <div class="modal-body"> <!--Cuerpo del modal-->
            <form action=""> <!--Aquí iría el recuperarCuenta.php-->
              <div class="mb-3"> <!--Seleccionar perfil (Bedel, profesor, alumno/a)-->
                <label for="inputPerfil2" class="form-label">Seleccione su perfil</label>
                <select id="inputPerfil2" class="form-select" aria-label="Default select example">
                  <option value="1"selected>Alumno</option>
                  <option value="2">Profesor</option>
                  <option value="3">Bedel</option>
                </select>
              ...
              <div class="mb-3"> <!--Ingresar correo electrónico -->
                <label for="inputEmail2" class="form-label">Ingrese su correo electrónico</label>
                <input type="text" id="inputEmail2" class="form-control" aria-describedby="passwordHelpBlock">
              </div>
